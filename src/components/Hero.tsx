...
export default function Hero() {
  ...
  useEffect(() => {
    ...
    else { setDel(false); setIdx(i => (i+1) % specializations.length); }
          ...
          <div style={{display:"grid",gap:"3rem",alignItems:"center"}} className="hero-grid">
            ...
            <div>
              ...
              <div data-aos="fade-up" style={{
                ...
                <span style={{width:7,height:7,borderRadius:"50%",background:"var(--color-red)",
                  animation:"pulseGlow 2s ease-in-out infinite"}}/>
                <span style={{fontFamily:"var(--font-mono)",fontSize:"0.62rem",letterSpacing:"0.14em",color:"var(--color-red)"}}>
                  EN STAGE FIN D'ÉTUDES · INGÉNIEUR EN JUIL. 2026
                </span>
              </div>

              {/* Name */}
              <h1 data-aos="fade-up" data-aos-delay="100" style={{
                fontFamily:"var(--font-sans)",fontWeight:700,lineHeight:0.95,
              ...
              {/* Title — static line 1 */}
              <p data-aos="fade-up" data-aos-delay="170" style={{
              ...
              {/* Subtitle chips */}
              <p data-aos="fade-up" data-aos-delay="240" style={{
                fontWeight:600,fontSize:"0.88rem",color:"var(--color-text)",
                marginBottom:"0.75rem",letterSpacing:"0.02em",
              }}>
                Systèmes Embarqués · IoT · Full-Stack · Marketing Digital
              </p>
              <p data-aos="fade-up" data-aos-delay="280" style={{
                color:"var(--color-muted)",fontSize:"0.88rem",
                maxWidth:480,lineHeight:1.75,marginBottom:"2rem",
              }}>
                Étudiant à l'ENSP Douala, passionné par le développement logiciel et l'IoT.
                Expériences en milieux bancaire et BTP. CEO de{" "}
                <strong style={{color:"var(--color-text)"}}>STRIDENOV</strong>.
              </p>

              {/* Stats */}
              <div data-aos="fade-up" data-aos-delay="320" style={{display:"flex",gap:"2.5rem",marginBottom:"2rem"}}>
                {[{v:"3+",l:"Stages"},{v:"6+",l:"Projets"},{v:"1",l:"Certif. Cisco"}].map(({v,l})=>(
                  <div key={l}>
              ...
              <div data-aos="fade-up" data-aos-delay="380" style={{display:"flex",flexWrap:"wrap",gap:"0.75rem"}}>
                <a href="/CV_Joan_Brunel.pdf" download style={{
                  display:"inline-flex",alignItems:"center",gap:8,
                  padding:"0.7rem 1.5rem",background:"var(--color-red)",color:"#fff",
                  fontFamily:"var(--font-mono)",fontSize:"0.7rem",letterSpacing:"0.1em",
                  textTransform:"uppercase",borderRadius:4,textDecoration:"none",
                  border:"1px solid var(--color-red)",transition:"background 0.2s",
                }}
                ...
                <button onClick={()=>document.getElementById("contact")?.scrollIntoView({behavior:"smooth"})} style={{
                  display:"inline-flex",alignItems:"center",gap:8,
                  padding:"0.7rem 1.5rem",background:"transparent",color:"var(--color-text)",
                  fontFamily:"var(--font-mono)",fontSize:"0.7rem",letterSpacing:"0.1em",
                  textTransform:"uppercase",borderRadius:4,border:"1px solid var(--color-border)",cursor:"pointer",
            ...
            <div data-aos="fade-left" data-aos-delay="150" className="hero-avatar" style={{display:"flex",justifyContent:"center"}}>
              <div style={{position:"relative",display:"inline-block"}}>
                ...
                <div style={{
                  width:290,height:290,borderRadius:"50%",overflow:"hidden",
                  border:"2px solid rgba(224,32,32,0.5)",
                  background:"var(--color-surface)",
                  display:"flex",alignItems:"center",justifyContent:"center",
                }}>
                  {/* Replace with your photo: */}
                  <img src="/images/avatar.jpeg" alt="Joan Brunel" style={{width:"100%",height:"100%",objectFit:"cover"}}/> 
                  <div style={{textAlign:"center",color:"var(--color-dim)",fontFamily:"var(--font-mono)",fontSize:"0.72rem"}}>
                  </div>
                </div>
        ...
        <div className="marquee-inner" style={{padding:"0.9rem 0"}}>
          {[...techStack,...techStack].map((t,i)=>(
            <span key={i} style={{fontFamily:"var(--font-mono)",fontSize:"0.72rem",color:"var(--color-muted)",whiteSpace:"nowrap",paddingRight:"2.5rem"}}>
              {t}<span style={{color:"var(--color-red)",padding:"0 1.2rem"}}>·</span>
            </span>
          ))}
        </div>
      </div>
